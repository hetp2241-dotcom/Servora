...
class ProviderProfile(models.Model):
    ...
    latitude = models.DecimalField(max_digits=9, decimal_places=6, default=23.022500)
    longitude = models.DecimalField(max_digits=9, decimal_places=6, default=72.571400)
